...
public class QuizPageNo8 extends AppCompatActivity {
    Button c1,c2,c3,c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         i = getIntent().getIntExtra("ans7", 0);
        Toast.makeText(this,""+i,Toast.LENGTH_SHORT).show();
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_page_no8);
        c1 = findViewById(R.id.buttonChoiceNo1c8);
        c2 = findViewById(R.id.buttonChoiceNo2c8);
        c3 = findViewById(R.id.buttonChoiceNo3c8);
        c4 = findViewById(R.id.buttonChoiceNo4c8);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                Intent in = new Intent(QuizPageNo8.this,QuizPageNo9.class);
                in.putExtra("ans8",i);
                startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    Toast.makeText(QuizPageNo8.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo8.this,QuizPageNo9.class);
                    in.putExtra("ans8",i);
                    startActivity(in);
                    finish();
