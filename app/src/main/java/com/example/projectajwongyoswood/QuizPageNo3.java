...
public class QuizPageNo3 extends AppCompatActivity {
    Button c1, c2, c3, c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_page_no3);

         i = getIntent().getIntExtra("ans2", 0);
        Toast.makeText(this, "" + i, Toast.LENGTH_SHORT).show();
        c1 = findViewById(R.id.buttonChoiceNo1c3);
        c2 = findViewById(R.id.buttonChoiceNo2c3);
        c3 = findViewById(R.id.buttonChoiceNo3c3);
        c4 = findViewById(R.id.buttonChoiceNo4c3);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        Intent in = new Intent(QuizPageNo3.this, QuizPageNo4.class);
                        in.putExtra("ans3", i + 1);
                        startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    check = true;
                    Toast.makeText(QuizPageNo3.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo3.this, QuizPageNo4.class);
                    in.putExtra("ans3", i);
                    startActivity(in);
                    finish();
