...
public class QuizPageNo5 extends AppCompatActivity {
    Button c1, c2, c3, c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_page_no5);
         i = getIntent().getIntExtra("ans4", 0);
        Toast.makeText(this, "" + i, Toast.LENGTH_SHORT).show();
        c1 = findViewById(R.id.buttonChoiceNo1c5);
        c2 = findViewById(R.id.buttonChoiceNo2c5);
        c3 = findViewById(R.id.buttonChoiceNo3c5);
        c4 = findViewById(R.id.buttonChoiceNo4c5);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                singleClick();
                c3.setBackgroundResource(R.drawable.style_green);
                ...
                Runnable r = new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent in = new Intent(QuizPageNo5.this, QuizPageNo6.class);
                        in.putExtra("ans5", i);
                        startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    Toast.makeText(QuizPageNo5.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo5.this, QuizPageNo6.class);
                    in.putExtra("ans5", i);
                    startActivity(in);
                    finish();
    ...
    void singleClick() {
        ...
        check = true;
        progressAnim.pause();
        YoYo.with(Techniques.RubberBand).duration(700).repeat(1).playOn(c3);
    }
}