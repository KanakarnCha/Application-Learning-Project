...
public class QuizPageNo10 extends AppCompatActivity {
    Button c1, c2, c3, c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_page_no10);
        i = getIntent().getIntExtra("ans9", 0);
        Toast.makeText(this, "" + i, Toast.LENGTH_SHORT).show();
        c1 = findViewById(R.id.buttonChoiceNo1c10);
        c2 = findViewById(R.id.buttonChoiceNo2c10);
        c3 = findViewById(R.id.buttonChoiceNo3c10);
        c4 = findViewById(R.id.buttonChoiceNo4c10);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        Intent in = new Intent(QuizPageNo10.this, Show_Point_page.class);
                        in.putExtra("ans10", i + 1);
                        startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    Toast.makeText(QuizPageNo10.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo10.this, Show_Point_page.class);
                    in.putExtra("ans10", i);
                    startActivity(in);
                    finish();
