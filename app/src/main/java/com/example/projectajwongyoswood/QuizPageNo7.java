...
public class QuizPageNo7 extends AppCompatActivity {
    Button c1, c2, c3, c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_page_no7);
         i = getIntent().getIntExtra("ans6", 0);
        Toast.makeText(this, "" + i, Toast.LENGTH_SHORT).show();
        c1 = findViewById(R.id.buttonChoiceNo1c7);
        c2 = findViewById(R.id.buttonChoiceNo2c7);
        c3 = findViewById(R.id.buttonChoiceNo3c7);
        c4 = findViewById(R.id.buttonChoiceNo4c7);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        Intent in = new Intent(QuizPageNo7.this, QuizPageNo8.class);
                        in.putExtra("ans7", i + 1);
                        startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    Toast.makeText(QuizPageNo7.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo7.this, QuizPageNo8.class);
                    in.putExtra("ans7", i);
                    startActivity(in);
                    finish();
