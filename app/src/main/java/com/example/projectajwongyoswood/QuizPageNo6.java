...
public class QuizPageNo6 extends AppCompatActivity {
    Button c1, c2, c3, c4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_page_no6);
         i = getIntent().getIntExtra("ans5", 0);
        Toast.makeText(this, "" + i, Toast.LENGTH_SHORT).show();
        c1 = findViewById(R.id.buttonChoiceNo1c6);
        c2 = findViewById(R.id.buttonChoiceNo2c6);
        c3 = findViewById(R.id.buttonChoiceNo3c6);
        c4 = findViewById(R.id.buttonChoiceNo4c6);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        Intent in = new Intent(QuizPageNo6.this, QuizPageNo7.class);
                        in.putExtra("ans6", i);
                        startActivity(in);
                        finish();
                    }
    ...
    void setProgressBar(){
        ...
        progressAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (check == false) {
                    Toast.makeText(QuizPageNo6.this,"หมดเวลา", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(QuizPageNo6.this, QuizPageNo7.class);
                    in.putExtra("ans6", i);
                    startActivity(in);
                    finish();
